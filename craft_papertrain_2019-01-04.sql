...
# Generation Time: 2019-01-05 00:21:47 +0000
# ************************************************************
...
INSERT INTO `content` (`id`, `elementId`, `siteId`, `title`, `dateCreated`, `dateUpdated`, `uid`, `field_titleOverride`)
VALUES
	(1,1,1,NULL,'2018-10-17 19:43:46','2018-12-08 13:41:30','4027dc44-49c1-4aaf-b85b-a6bc1a637bac',NULL),
	(34,187,1,NULL,'2018-12-08 15:05:37','2018-12-08 15:08:35','377a88cb-e33b-4b67-8c6c-15c055f800c2',NULL);
...
VALUES
	...
	(187,20,'craft\\elements\\GlobalSet',1,0,'2018-12-08 15:05:37','2018-12-08 15:08:35','89e25401-410b-4cab-a72e-39f1b9cbe910');
...
VALUES
	...
	(187,187,1,NULL,NULL,1,'2018-12-08 15:05:37','2018-12-08 15:08:35','46018157-75b7-471b-b72a-a587b2aad27e');
...
VALUES
	...
	(2663,20,603,75,0,1,'2018-12-08 15:08:12','2018-12-08 15:08:12','4e2f1d8c-a770-4ced-956f-2d245507bba5');
...
VALUES
	...
	(20,'craft\\elements\\GlobalSet','2018-12-08 15:05:37','2018-12-08 15:08:12','ac1d8fa2-c764-4b9d-9ce2-49b130827554');
...
VALUES
	...
	(603,20,'Settings',1,'2018-12-08 15:08:12','2018-12-08 15:08:12','c0e588e0-4bdd-4fd5-a9fd-39156ae8548e');
...
VALUES
	...
	(75,2,'Title Override','titleOverride','global','Optional title tab override.','none',NULL,'craft\\fields\\PlainText','{\"placeholder\":\"\",\"code\":\"\",\"multiline\":\"\",\"initialRows\":\"4\",\"charLimit\":\"\",\"columnType\":\"text\"}','2018-12-08 15:06:34','2018-12-08 15:06:34','3d7541d7-216a-4c35-b277-ccdedf46dd56');
...
VALUES
	(187,'Site Settings','siteSettings',20,'2018-12-08 15:05:37','2018-12-08 15:08:12','1c9577c8-c0d3-4b4b-8fa6-c629ff9c5c57');
...
VALUES
	(1,'3.0.36','3.0.94',0,'America/New_York','Papertrain Boilerplate',1,0,'kT8CkP7JjMhQ','2018-10-17 19:43:46','2019-01-05 00:21:19','bdebff9e-a915-4f72-a9be-e9715430bcd0');
...
VALUES
	(1,'eager-beaver','1.0.4','1.0.0',NULL,'unknown',1,NULL,'2018-11-06 19:48:48','2018-11-06 19:48:48','2019-01-05 00:21:37','75e3b61a-23b8-440d-9ca8-02214229f452'),
	(2,'imager','v2.1.3','2.0.0',NULL,'unknown',1,NULL,'2018-11-06 19:48:52','2018-11-06 19:48:52','2019-01-05 00:21:37','5880e16d-544d-40d8-a11e-18c07ee2cce6'),
	(3,'splash','3.0.2','3.0.0',NULL,'unknown',1,'{\"volume\":\"1\",\"authorField\":\"\",\"authorUrlField\":\"\",\"colorField\":\"\"}','2018-11-06 20:03:24','2018-11-06 20:03:24','2019-01-05 00:21:37','7c311bf3-2d90-42f0-9a51-a4c6d4ed7132'),
	(5,'freeform','2.5.7','2.1.3',NULL,'invalid',1,NULL,'2018-11-07 16:07:44','2018-11-07 16:07:44','2019-01-05 00:21:37','9010b6b3-f122-4d41-b17d-45d5d40ad60d'),
	(6,'redactor','2.1.7','2.0.0',NULL,'unknown',1,NULL,'2018-11-21 13:02:36','2018-11-21 13:02:36','2019-01-05 00:21:37','fd1449da-2f55-4f0a-9ee8-bedac1c9d5f1'),
	(7,'super-table','2.0.14','2.0.4',NULL,'unknown',1,NULL,'2018-11-28 19:02:30','2018-11-28 19:02:30','2019-01-05 00:21:37','728b3ecb-d511-457b-886b-d3fd46365966'),
	(8,'typedlinkfield','1.0.15','1.0.0',NULL,'unknown',1,NULL,'2018-11-28 19:02:32','2018-11-28 19:02:32','2019-01-05 00:21:37','e5f156c9-3384-4316-9e6d-25430506b1cd');
...
# Dump of table stc_10_rows
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stc_10_rows`;

CREATE TABLE `stc_10_rows` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `elementId` int(11) NOT NULL,
  `siteId` int(11) NOT NULL,
  `dateCreated` datetime NOT NULL,
  ...
  CONSTRAINT `stc_10_rows_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stc_10_rows_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table stc_11_listitems
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stc_11_listitems`;

CREATE TABLE `stc_11_listitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `elementId` int(11) NOT NULL,
  `siteId` int(11) NOT NULL,
  `dateCreated` datetime NOT NULL,
  ...
  CONSTRAINT `stc_11_listitems_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stc_11_listitems_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table stc_7_buttons
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stc_7_buttons`;

CREATE TABLE `stc_7_buttons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `elementId` int(11) NOT NULL,
  `siteId` int(11) NOT NULL,
  `dateCreated` datetime NOT NULL,
  ...
  CONSTRAINT `stc_7_buttons_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stc_7_buttons_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table stc_9_slides
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stc_9_slides`;

CREATE TABLE `stc_9_slides` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `elementId` int(11) NOT NULL,
  `siteId` int(11) NOT NULL,
  `dateCreated` datetime NOT NULL,
  ...
  CONSTRAINT `stc_9_slides_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stc_9_slides_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `stc_9_slides` WRITE;
/*!40000 ALTER TABLE `stc_9_slides` DISABLE KEYS */;

INSERT INTO `stc_9_slides` (`id`, `elementId`, `siteId`, `dateCreated`, `dateUpdated`, `uid`, `field_headline`, `field_body`)
VALUES
...
/*!40000 ALTER TABLE `stc_9_slides` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'kylea@page.works',NULL,'','','kylea@page.works','$2y$13$.tPQ1u13.ms0je3ZbN1jnOaMx4ummoMNCAhSbB338o.Cs/6zf4swK',1,0,0,0,'2019-01-05 00:07:19','::1',NULL,NULL,'2018-12-14 16:58:06',NULL,1,NULL,NULL,NULL,0,'2018-12-08 13:41:32','2018-10-17 19:43:49','2019-01-05 00:07:19','e44094df-7375-4fff-a0a5-d88d45bbefcb');
